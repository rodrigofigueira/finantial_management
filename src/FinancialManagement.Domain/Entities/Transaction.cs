...
public sealed class Transaction : EntityBase
{
    ...
    public Transaction(string name, decimal value, Category category) => ValidateDomain(name, value, category);
    ...
    public void Update(string name, decimal value, Category category) => ValidateDomain(name, value, category);
